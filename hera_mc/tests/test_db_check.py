...
def test_sanity_pass(db_name=test_db):
    """
...
def test_sanity_table_missing(db_name=test_db):
...
def test_sanity_column_missing(db_name=test_db):
    """See check fails when there is a missing table"""
...
def test_sanity_pass_relationship(db_name=test_db):
    """
