...
from hera_mc import cm_partconn, mc, cm_utils, cm_handling, cm_revisions
...
class TestParts(TestHERAMC):
    ...
    def test_update_new(self):
        ...
        cm_partconn.update_part(self.test_session, data, add_new_part=True)
    ...
    def test_update_update(self):
        ...
        cm_partconn.update_part(self.test_session, data, add_new_part=False)
    ...
    def test_show_parts(self):
        cm_partconn.add_part_info(self.test_session, self.test_part, self.test_rev, self.start_time, 'Testing', 'library_file')
    ...
    def test_part_info(self):
        cm_partconn.add_part_info(self.test_session, self.test_part, self.test_rev, Time('2017-07-01 01:00:00'),
    ...
    def test_add_new_parts(self):
        ...
        p = cm_partconn.Parts()
        cm_partconn.add_new_parts(self.test_session, p, data, Time('2017-07-01 01:00:00', scale='utc'), True)
