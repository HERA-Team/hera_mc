...
class Handling:
    ...
    def is_in_connections(self, station_name, check_if_active=False):
        """
    ...
    def locate_station(self,to_find, query_date, show_location=False):
        """
    ...
    def overplot(self, located, fignm):
