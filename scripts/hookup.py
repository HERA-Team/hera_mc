...
if __name__ == '__main__':
    ...
    parser.add_argument('-f', '--force-new-cache', dest='force_new_cache', help="Force it to write a new hookup file.", action='store_true')
    parser.add_argument('-c', '--cache-info', help="Shows information about the hookup cache file.", dest='cache_info', action='store_true')
    parser.add_argument('--force-specific', dest='force_specific', help="Force db use (but doesn't rewrite)", action='store_true')
    ...
    if args.cache_info:
        ...
        hookup_dict = hookup.get_hookup(hpn_list=args.hpn, rev=args.revision, port_query=args.port,
                                        ...
                                        force_new_cache=args.force_new_cache, force_specific=args.force_specific,
