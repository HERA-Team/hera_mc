...
if __name__ == '__main__':
    ...
    parser.add_argument('--starttime', help="Required if command is 'take_data', "
                        ...
                        "format and scale separately (string).", default=None)
    ...
    parser.add_argument('--tag', help="Required if command is 'take_data', "
                        ...
                        + ', '.join(corr.tag_list) + '.', default=None)
    ...
    parser.add_argument('--overwrite_take_data', help="Only used if command is "
                        ...
                        default=False)
    parser.add_argument('--config_file', help="Only used if command is "
                        "'update_config', ignored otherwise. Config file to "
                        "command the correlator to use (string).", default=None)
    parser.add_argument('--dryrun', help="Just print the list of "
                        "CorrelatorControlCommand (and possibly other) objects, "
                        "that would be added to the database, do not issue the "
                        "commands or log them to the database [False]", action='store_true')
