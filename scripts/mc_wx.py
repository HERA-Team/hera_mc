...
if __name__ == '__main__':
    ...
    if args.add_to_db:
        ...
        for w in wx:
            ...
            print("{}: {} ({:.0f}) = {} {}".format(
                w.variable, cm_utils.get_time_for_display(w.time), w.time, w.value, units))
