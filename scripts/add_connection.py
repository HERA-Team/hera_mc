...
from hera_mc import mc, cm_utils, cm_partconn, cm_handling, cm_health
...
if __name__ == '__main__':
    ...
    connect = cm_partconn.Connections()
    ...
    if go_ahead:
        ...
        cm_partconn.add_new_connections(session, connect, npc, at_date, args.actually_do_it)
