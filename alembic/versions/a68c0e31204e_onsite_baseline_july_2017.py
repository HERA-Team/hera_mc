...
def upgrade():
    ...
    op.create_table('autocorrelations',
    ...
    sa.Column('start_date', sa.DateTime(timezone=True), nullable=False),
    sa.Column('stop_date', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['downstream_part', 'down_part_rev'], ['parts_paper.hpn', 'parts_paper.hpn_rev'], ),
    sa.ForeignKeyConstraint(['upstream_part', 'up_part_rev'], ['parts_paper.hpn', 'parts_paper.hpn_rev'], ),
    sa.PrimaryKeyConstraint('upstream_part', 'up_part_rev', 'downstream_part', 'down_part_rev', 'upstream_output_port', 'downstream_input_port', 'start_date')
    )
    ...
    sa.ForeignKeyConstraint(['station_type_name'], [u'station_type.station_type_name'], ),
