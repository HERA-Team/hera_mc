...
def upgrade():
    ...
    op.alter_column('rtp_process_record', 'git_version', new_column_name='rtp_git_version')


def downgrade():
    op.alter_column('rtp_process_record', 'rtp_git_version', new_column_name='git_version')
