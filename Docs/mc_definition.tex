...
The correlator tables are not all defined yet. Below are the defined tables followed by notes on future plans.
...
\textbf{\large{node\_sensor}}: Node temperature and humidity sensor readings
\begin{center}
 \begin{tabular}{| p{4cm} | p{2cm} | p{10cm} |}
\hline
 column & type & description \\ [0.5ex]  \hline\hline
...
\textbf{\large{node\_power\_status}}: Power status for SNAPs, FEMs and PAMs (monitored by nodes)
\begin{center}
 \begin{tabular}{| p{4cm} | p{2cm} | p{10cm} |}
\hline
 column & type & description \\ [0.5ex]  \hline\hline
...
\textbf{\large{roach\_temperature}}: Roach (correlator fpga board) temperatures (deprecated 8/2018)
\begin{center}
 \begin{tabular}{| p{4cm} | p{2cm} | p{10cm} |}
\hline
 column & type & description \\ [0.5ex]  \hline\hline
...
\subsubsection{Correlator Table plans}
